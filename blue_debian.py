...
cap = {
    ...
    e.EV_ABS : [
        ...
        (e.ABS_PRESSURE, AbsInfo(value=minpressure, min=minpressure, max=maxpressure, fuzz=0, flat=0, resolution=0)),
        (e.ABS_X, AbsInfo(value=minxpos, min=minxpos, max=maxxpos, fuzz=0, flat=0, resolution=0)),
        (e.ABS_Y, AbsInfo(value=minxpos, min=minypos, max=maxypos, fuzz=0, flat=0, resolution=0))]
}
