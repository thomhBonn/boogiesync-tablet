...
# following 4 entries are original
minxpos = 0
minypos = 0
maxxpos = 19780
maxypos = 13442
...
cap = {
    ...
    e.EV_ABS : [
        ...
        (e.ABS_PRESSURE, AbsInfo(value=minpressure, min=0, max=maxpressure, fuzz=0, flat=0, resolution=0)),
        (e.ABS_X, AbsInfo(value=minxpos, min=minxpos, max=maxxpos, fuzz=0, flat=0, resolution=0)),
        (e.ABS_Y, AbsInfo(value=minypos, min=minypos, max=maxypos, fuzz=0, flat=0, resolution=0))]
}
